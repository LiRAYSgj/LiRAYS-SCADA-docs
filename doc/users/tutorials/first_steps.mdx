...
- [Docker](/users/installation/docker.mdx)
- [Linux package](/users/installation/linux.mdx)
- [macOS package](/users/installation/macos.mdx)
...
- If authentication is enabled and this is the first startup, complete the setup flow in the browser (the app redirects automatically).

To review related settings, use [Settings File Configuration](/users/configuration/settings_file.mdx).
...
Apply any changes and restart the service as described in [Settings File Configuration](/users/configuration/settings_file.mdx).
...
- [Users Guide](/users/index.mdx) for operations,
- [Integrators Guide](/integrators/index.mdx) for SDK/client integration,
- [Developers Guide](/developers/index.mdx) for code-level extension.
