...
- [Linux package](../installation/linux.mdx)
- [macOS package](../installation/macos.mdx)
...
To review related settings, use [Settings File Configuration](../configuration/settings_file.mdx).
...
Apply any changes and restart the service as described in [Settings File Configuration](../configuration/settings_file.mdx).
...
- [Users Guide](../index.mdx) for operations,
